...
ontology skills get generate-mdl            # generate MDL from a database schema
...
```bash
ontology --sql '...'                        # execute SQL through the MDL layer
ontology query --sql '...'                  # same, explicit
ontology dry-plan --sql '...'               # transpile only, no DB hit
ontology context show / build / validate    # project / MDL lifecycle
